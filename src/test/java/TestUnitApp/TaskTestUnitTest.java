...
class TaskTestUnitTest {
  ...
  @Test
  void filter5() {
    String origin = "   ##$0%^&AHCehsbaucbihja  Wb ii dHodg  yGY AGHabd h Ee  II hyHEAHBb  WAH ibIdaHBADA Ydywhb ^@AaIo&Yi*Q o ASvbxgavs x   ";
    String expected = "   ##$0%^&hchsbcbhj  wb  dhdg  ygy ghbd h    hyhhbb  wh bdhbd ydywhb ^@&y*q  svbxgvs x   ";
    String actual = task.filter(origin);
    assertEquals(expected, actual);
  }
